This End User License Agreement ("Agreement") is a legal contract between you as an individual or business organisation ("you" or "Licensee") and Lambda Factory Krzysztof Cieslak ("Licensor") for the Neptune for specified code editor software, including any associated media, printed materials and electronic documentation (the "Software").
...
Software is protected by Polish Copyright Law and International Treaty provisions. Further, the structure, organization, and code embodied in Software are the valuable and confidential trade secrets of Licensor and its suppliers and are protected by intellectual property laws and treaties. Licensee agrees to abide by the copyright law and all other applicable laws.

# RESTRICTED USE DURING EVALUATION PERIOD

Subject to the terms of this Agreement, Licensee is granted a right to use Software for evaluation purposes without charge for a period of seven (7) days from the date of installation of Software unless otherwise specified ("Evaluation Period").
...
A Permitted Number of personnel may install and use the software for your internal business purposes. "Permitted Number" means a number less than or equal to the number of seats you have purchased and paid for when acquiring the Software. The Software is installed using editor extension installer.
...
A License is eligible for a free upgrade to any major or minor version of the Software released within the duration of the license. The Software contains an automatic update and license key checker that checks for new versions of the Software regularly by connecting to the Licensor's server. The Licensor has no obligation to provide updates or upgrades to the Software, or otherwise maintain or support the Software.

# DATA

The Software may collect information about your use of the software, and send that to the Licensor. Licensor may use this information to improve their products and services. Collected information are anonymized and in no case does the Software collect any information from content processed by the Licensee.
...
The license fees are payable in accordance with the payment methods stipulated on the Software website.

# CONTROLLING LAW

This Agreement will be governed by the laws of Poland and you submit to the jurisdiction of the High Court of Poland. This Agreement is not subject to the United Nations Convention on Contracts for the Sale of Goods.
